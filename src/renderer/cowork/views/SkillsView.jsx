    ...
    >
      ...
      <div className="flex-1 px-3 flex flex-col gap-1">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {skill.enabled === false && (
            <span className="shrink-0 inline-flex items-center h-5 px-2 rounded-[4px] border border-solid border-line text-ink-3 font-[family-name:var(--font-body)] text-xs font-medium" style={{
        ...
        <span
          ...
          className="font-[family-name:var(--font-body)] text-base leading-[1.5] text-ink-3 line-clamp-2"
        >
      ...
      {/* Footer */}
      <div className="flex items-center justify-between px-3 py-2 bg-bg font-[family-name:var(--font-body)] text-sm text-ink-3" style={{
    ...
    <Modal open={open} onClose={onClose} width="549px" labelledBy="upload-skill-title">
      ...
      <ModalBody padding="20px">
        <div className="flex flex-col gap-4">
          ...
          >
            {file ? (
              <>
                ...
                <span className="text-base font-[family-name:var(--font-body)] text-ink-2 font-medium">
                  {file.name}
                </span>
                <span className="text-sm font-[family-name:var(--font-body)] text-ink-4">
              ...
              <>
                ...
                <span className="text-base font-[family-name:var(--font-body)] text-ink-3">
          ...
          {/* File requirements */}
          <div className="text-sm leading-[16px] text-ink-3 font-[family-name:var(--font-body)]">
              ...
              {sorted.map((skill) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[1fr_2fr_auto_auto] gap-x-4 px-2 py-3 border-b border-solid border-line cursor-pointer rounded-card-row outline-none"
                    onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--surface-2)'; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = ''; }}
                  >
                    <span className="font-[family-name:var(--font-body)] text-sm font-medium text-ink overflow-hidden text-ellipsis whitespace-nowrap">{skill.label}</span>
                    <span className="font-[family-name:var(--font-body)] text-sm text-ink-3 overflow-hidden text-ellipsis whitespace-nowrap">{skill.description || '—'}</span>
                    <span className="font-[family-name:var(--font-body)] text-sm text-ink-3 whitespace-nowrap">{project || '—'}</span>
