...
import { orderUnlockedFirst, effectiveTier } from '../lib/modelEntitlement';
import { isRoleModelLocked } from '../lib/roleModels';
      ...
      <CollapsibleGroup title="Agent Models">
        {(() => {
          ...
          const RoleRow = ({ role, label }) => {
            ...
            // fallback). Absent id ⇒ available; direct providers have no such flag.
                ...
                <div style={{ display: 'grid', gap: 6 }}>
                  ...
                  {modelList.length > 0 ? (
                    (() => {
                      ...
                      const gated = modelList.map((o) => ({ ...o, locked: isRoleModelLocked(o, tier, modelEnabled) }));
