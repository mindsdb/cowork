...
function inferProviderPreset(s) {
  ...
  if (provider === "openai-compatible") {
    ...
    if (
      ...
      (baseUrl.endsWith(MINDS_API_PATH_SUFFIX) && (s.mindsApiKey || s.mindsUrl))
    ) {
      return "minds-cloud";
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {Ico.chevronRight ? Ico.chevronRight(12) : "›"}
        </span>
        <span style={{ flex: 1 }}>{title}</span>
      </button>
      {open && <div style={{ padding: "0 18px 8px" }}>{children}</div>}
    </div>
  );
}
        ...
        >
          <div style={{ maxWidth: 820 }}>
            ...
            >
              <span
                style={{
                  ...
                  background: configReady
                    ? "rgba(93,146,135,0.16)"
                    : "rgba(211,80,80,0.14)",
                }}
              >
                {configReady ? Ico.check(15) : Ico.key(15)}
              </span>
              <div style={{ flex: 1 }}>
                <div
                  style={{
            ...
            <CollapsibleGroup title="Appearance">
              <Section
                title="Theme"
                subtitle="Light or dark — also drives the animated background."
              >
                <Segmented
                  value={theme || "dark"}
              ...
              <Section
                title="Greeting"
                subtitle="The line shown when you start a new task."
              >
                <TextInput
              ...
              <Section
                title="Dot grid"
                subtitle="Decorative dot pattern on the home screen."
              >
                <Toggle
              ...
              <Section
                title="Auto-pin recents"
                subtitle="Pin tasks you visit more than 3 times."
              >
                <Toggle
                  value={settings.autoPin}
                  onChange={(v) => setSetting("autoPin", v)}
                />
              </Section>
            </CollapsibleGroup>
            ...
            <CollapsibleGroup title="Models">
              ...
              <Section
                title="Provider"
                subtitle="Both planning + coding. Gemini and Minds Cloud are presets that map to OpenAI-compatible with the right base URL."
              >
                <Segmented
              ...
              <Section
                title="Coding model"
                subtitle="Used for scratchpad code generation."
              >
                <TextInput
            ...
            <CollapsibleGroup title="Credentials">
              ...
              <Section
                ...
                subtitle="Required for GPT models when you use OpenAI directly."
              >
                <ApiKeyInput
              ...
              <Section
                ...
                subtitle="Required for OpenAI-compatible providers unless Minds credentials derive it."
              >
                <TextInput
            ...
            <CollapsibleGroup title="Updates" defaultOpen={false}>
              <Section
                title="UI updates"
                subtitle="How Anton handles new UI versions delivered over the air."
              >
                <Segmented
            ...
            <CollapsibleGroup title="Memory" defaultOpen={false}>
              <Section
                title="Memory mode"
                subtitle="How Anton updates its long-term memory."
              >
                <Segmented
              ...
              <Section
                ...
                subtitle="Save conversation history for future recall."
              >
                <Toggle
              ...
              <Section
                ...
                subtitle="Auto-generate HTML reports from scratchpad output."
              >
                <Toggle
