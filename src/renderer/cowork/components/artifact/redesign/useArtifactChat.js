...
//
// House rules: React 19 hooks only, no new deps, defensive — if the stream throws
// synchronously we surface a readable error rather than crashing the workspace.
