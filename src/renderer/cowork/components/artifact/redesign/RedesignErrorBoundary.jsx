...
export class RedesignErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    console.error('[artifact-redesign] workspace crashed:', error, info && info.componentStack);
  }
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 780, margin: '0 auto' }}>
            ...
            <div style={{ color: '#C7D2E5', lineHeight: 1.55, marginBottom: 16 }}>
              The redesigned artifact workspace crashed. Please include this message and stack in the review notes.
            </div>
