...
//   `tag` renders as a compact right-aligned pill on the row (e.g. the
//   "Needs credits" wallet state, ENG-1248) without touching the label,
//   so search still matches the bare model name and nothing truncates.
//
