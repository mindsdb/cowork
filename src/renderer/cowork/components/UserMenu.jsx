 ...
 *
 * **The organization picker lives here rather than in the rail**, and the
 * workspace picker's placement is the same decision read the other way. An
 * organization is who is paying; a workspace is a container inside it. The
 * account menu is about identity, so the organization belongs in it and the
 * workspace does not, which is why the workspace picker is its own control
 * immediately above this footer rather than a group in here. The console puts
 * its organization selector in exactly this menu too.
 *
