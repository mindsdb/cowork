      ...
      <div className="search-modal" onMouseDown={(event) => event.stopPropagation()}>
        <div className="search-head">
          ...
          <input
            ...
            value={query}
            type="search"
            placeholder="Search Minds Cowork"
            aria-label="Search Minds Cowork"
        ...
        <div className="search-results">
          ...
          {!busy && query.trim() && results.length === 0 && !error && <div className="search-empty">No Minds Cowork results found.</div>}
