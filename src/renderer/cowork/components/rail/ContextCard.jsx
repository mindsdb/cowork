...
function ContextFileRow({ file, onOpen, onRequestDelete }) {
  const isAnton = file.path === COWORK_PROJECT_INSTRUCTIONS_PATH;
    ...
    listProjectFiles(project.name)
      .then((data) => {
        ...
        const visible = all.filter((f) => {
          ...
          if (p === COWORK_PROJECT_INSTRUCTIONS_PATH) return true;
        ...
        visible.sort((a, b) => {
          const ai = a.path === COWORK_PROJECT_INSTRUCTIONS_PATH ? 0 : 1;
          const bi = b.path === COWORK_PROJECT_INSTRUCTIONS_PATH ? 0 : 1;
  ...
  return (
    <div className="flex flex-col gap-3 pt-2">
      ...
      <ContextFileModal
        ...
        isAntonMd={openFile?.path === COWORK_PROJECT_INSTRUCTIONS_PATH}
