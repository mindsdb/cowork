...
describe('buildModelPickerOptions', () => {
  it('produces the same provider, family, version, and wallet metadata for every picker', () => {
    ...
    expect(buildModelPickerOptions(models, {
      ...
      { value: 'sonnet', label: 'Claude Sonnet 5', tag: 'Latest · Needs credits', provider: 'anthropic', disabled: true, locked: true },
      { value: 'sonnet-4-5', label: 'Claude Sonnet 4.5', tag: 'Older version · Needs credits', provider: 'anthropic', disabled: true, locked: true },
    ]);
  });
