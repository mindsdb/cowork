...
async def list_integrations():
    ...
    vault = LocalDataVault()
    return {"items": [_google_drive_integration_item(vault), _google_calendar_integration_item(vault), _gmail_integration_item(vault), _github_integration_item(vault)]}
