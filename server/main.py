"""
MindsHub Cowork — FastAPI backend server.
...
app = FastAPI(title="MindsHub Cowork API", version="1.0.0", lifespan=lifespan)
...
if __name__ == "__main__":
    ...
    logger.info("─" * 50)
    logger.info("MindsHub Cowork server starting on %s:%d", host, port)
